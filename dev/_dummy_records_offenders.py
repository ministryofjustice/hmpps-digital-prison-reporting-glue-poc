...
glueContext.write_dynamic_frame.from_options(
    frame=out_dyf_b,
    connection_type="s3",
    connection_options={"path": "s3://{}/base/".format(output_path_table)},
    format="json",
)
...
glueContext.write_dynamic_frame.from_options(
    frame=out_dyf,
    connection_type="s3",
    connection_options={"path": "s3://{}/events/".format(output_path_events)},
    format="json",
)
...
print("s3://{}/events/".format(output_path_events))
