...
test_schema = StructType(
    [StructField('offender_id', IntegerType(), True), StructField('offender_name_seq', IntegerType(), True),
     StructField('id_source_code', StringType(), True), StructField(
         'last_name', StringType(), True),
     StructField('name_type', StringType(), True), StructField(
         'first_name', StringType(), True),
     StructField('middle_name', StringType(), True), StructField(
         'birth_date', DateType(), True),
     StructField('sex_code', StringType(), True), StructField(
         'suffix', StringType(), True),
     StructField('last_name_soundex', StringType(), True), StructField(
         'birth_place', StringType(), True),
     StructField('birth_country_code', StringType(), True), StructField(
         'create_date', DateType(), True),
     StructField('last_name_key', StringType(), True), StructField(
         'alias_offender_id', IntegerType(), True),
     StructField('first_name_key', StringType(), True), StructField(
         'middle_name_key', StringType(), True),
     StructField('offender_id_display', StringType(), True), StructField(
         'root_offender_id', IntegerType(), True),
     StructField('caseload_type', StringType(), True), StructField(
         'modify_user_id', StringType(), True),
     StructField('modify_datetime', TimestampType(), True), StructField(
         'alias_name_type', StringType(), True),
     StructField('parent_offender_id', IntegerType(), True), StructField(
         'unique_obligation_flag', StringType(), True),
     StructField('suspended_flag', StringType(), True), StructField(
         'suspended_date', DateType(), True),
     StructField('race_code', StringType(), True), StructField(
         'remark_code', StringType(), True),
     StructField('add_info_code', StringType(), True), StructField(
         'birth_county', StringType(), True),
     StructField('birth_state', StringType(), True), StructField(
         'middle_name_2', StringType(), True),
     StructField('title', StringType(), True), StructField(
         'age', IntegerType(), True),
     StructField('create_user_id', StringType(), True), StructField(
         'last_name_alpha_key', StringType(), True),
     StructField('create_datetime', TimestampType(), True), StructField(
         'name_sequence', StringType(), True),
     StructField('audit_timestamp', TimestampType(), True), StructField(
         'audit_user_id', StringType(), True),
     StructField('audit_module_name', StringType(), True), StructField(
         'audit_client_user_id', StringType(), True),
     StructField('audit_client_ip_address', StringType(), True),
     StructField('audit_client_workstation_name', StringType(), True),
     StructField('audit_additional_info', StringType(), True), StructField(
         'admin_hash', StringType(), True),
     StructField('admin_gg_pos', StringType(), True), StructField(
         'admin_gg_op_ts', TimestampType(), True),
     StructField('admin_event_ts', TimestampType(), True), StructField(
         'event_type', StringType(), True),
     StructField('previous_hash', StringType(), True), StructField(
         'table', StringType(), True),
...
def test_apply_events(spark_session):
    ...
    df_event_log = spark_session.read.parquet(read_logs)
    table_list = get_distinct_column_values_from_df(
        frame=df_event_log, column="table")
